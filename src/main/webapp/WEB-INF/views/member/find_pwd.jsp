...
<body>
	...
	<div id="nav">
		<span id="nav_a"> <a href="find_id" style="font-size: 18px;">아이디
				찾기&nbsp;&nbsp;</a>
		</span> <span id="selected"> <a href="find_pwd" style="font-size: 18px;">비밀번호
				찾기&nbsp;&nbsp;</a>
		</span>
	</div>

	<form action="find_pwd_ok" method="post" onsubmit="return check();">
	  <div class="inner">
